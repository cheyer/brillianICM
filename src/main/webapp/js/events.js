...
function loadMatrixAllocation () {
	...
	//Auswahl des Divs welches die "Zielfl�chen" des Matrixspiels enth�lt um ihn droppable zu machen (akzeptieren von divs erlauben)
	...
	continueButtonMatrix.bind('click', function(){
		...
		//Iteriere durch TileAcceptors, f�r jeden TitleAcceptor pr�fe, ob der Rank des sich in ihm befindlichen
	...
	//Drop Funktionalit�t f�r Platzhalter in Matrix und Ursprungscontainer, sodass teile wieder zur�ckgelegt werden k�nnen
